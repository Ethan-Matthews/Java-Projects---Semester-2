...
public class HourGlass extends Shape {
    ...
    public HourGlass(Color PrimaryColour, Color SecondaryColour, int width, int height, int xPos, int yPos, Animation ap, int xVel, int yVel) {
    ...
    public void drawShape(Graphics g) {
        ...
        int[] xValues = {getxPos(),getxPos() + getWidth(),getxPos(),getxPos() + getWidth()};
        int[] yValues = {getyPos(),getyPos() + getHeight(),getyPos() + getHeight(),getyPos()};
