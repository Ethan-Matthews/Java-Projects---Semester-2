...
public class Rectangle extends Shape {
    ...
    public Rectangle(Color PrimaryColour, Color SecondaryColour, int width, int height, int xPos, int yPos, Animation ap, int xVel, int yVel) {
